...
codes.each_with_index do |code, index| 
	request = Typhoeus::Request.new("http://guayacan.uninorte.edu.co/registro/resultado_codigo.asp", method: :post, body: {valida: "OK", mat: code, BtnCodigo: "Buscar", datos_periodo: "201430", nom_periodo: "Segundo Semestre 2014"})
